...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if(database) {
           ...
           message.channel.send('🗑️The project has been successfully deleted ✅')
           return message.channel.send(`Deleted the **${projectname}** project from our uptimer`).then(kah => kah.delete({timeout: 60000}));
        } else {
