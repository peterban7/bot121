...
module.exports = {
 ...
 if (!args2.toLowerCase().startsWith('https://')) return message.channel.send('URL must starts with "https://".');
...
message.channel.send('📣 Your bot is running 24h ✅')
return message.channel.send(`${args2} It's Hosted now`).then(kah => kah.delete({timeout: 60000}));
